        ...
        return BaseForm.extend({
            ...
            initializeDropzone() {
                ...
                myDropzone.on('success', function (file, message) {
                    ...
                    let errorDiv = file.previewElement.querySelector('.AknFieldContainer-validationError');
                    errorDiv.textContent = __(message.success);
                    errorDiv.style.backgroundImage = "none";
                    errorDiv.style.color = "#5992C7";
